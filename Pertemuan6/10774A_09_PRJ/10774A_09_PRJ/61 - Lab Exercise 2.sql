...
SELECT
	o.orderid, orderdate, SUM(d.qty * d.unitprice) AS salesamount
...
-- Task 2
-- 
-- Copy the T-SQL statement in task 1 and modify it to include the total number of order lines for each order and the average order line sales amount value within the order. 
...
LEFT OUTER JOIN Sales.OrderDetails AS d
ON d.orderid = o.orderid
